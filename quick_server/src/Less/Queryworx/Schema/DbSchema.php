...
use Less\Queryworx\Connection\PDOConnection;
...
abstract class DbSchema
{
	...
	public function getSchema($tableName)
	{
		...
		if(!isset($this->schema[$id]))
		{
			...
			$tableSchema = "Less\\Queryworx\\Schema\\".$driverName."\\".$driverName."TableSchema";
	...
	{
		return "Less\\Queryworx\\Schema\\".$driverName."\\".$driverName."Schema";
	}
}