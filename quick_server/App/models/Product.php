...
class Product extends Base
{
     ...
     * @var array
     */
    protected $_attrs = ['id', 'name', 'price', 'coin', 'quantity', 'min_count', 'max_count', 'image', 'hashRate', 'period',
        'status', 'income', 'type', 'is_hot', 'soldout', 'powerConsume', 'power', 'manage', 'insurance', 'tag', 'sort', 'createdAt', 'Trusteeship_at', 'intro', 'cost', 'notice','cny','ja','ko','lang'];
